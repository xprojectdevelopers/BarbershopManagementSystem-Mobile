...
export default function AppointmentScreen() {
  ...
  const handleBookAppointment = async () => {
    ...
    console.log('Pending to push notification...');
  ...
  return (
     <View style={styles.container}>
      <TouchableOpacity onPress={() => navigation.navigate({ name: 'Home', params: {} })} style={styles.backBtn}>
    ...
    <AppointmentPayment
      ...
      onConfirm={async () => {
        console.log('Pending to push notification for pay in person...');
        ...
        console.log('Notification pushed successfully for pay in person!');

        setModalVisible(false);
        navigation.navigate({ name: 'Home', params: { initialTab: 'Notification' } });
      }}
    />
   </View>
  );
